...
trait ResponseTrait {
    ...
    public function noAccessResponse($message, $response): JsonResponse
    {
        return response()->json([
            'status' => false,
            'code' => Constants::HTTP_NO_ACCESS,
            'message' => $message,
            'response' => $response
        ]);
    }

    public function unAuthorized($message, $response): JsonResponse
    {
        return response()->json([
            'status' => false,
            'code' => Constants::UN_AUTHORIZED,
            'message' => $message,
            'response' => $response
        ]);
    }
